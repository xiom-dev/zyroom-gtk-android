...
object Gisements {
    ...
    val TABLE: Map<Cle, Gisement> = mapOf(
        ...
        Cle("supreme", "resin", "fung") to Gisement(listOf(50.0f to 100.0f), listOf(Point(1386, -13540, "Terre de la Continuité"), Point(1650, -14891, "Profondeurs Interdites"), Point(1909, -13987, "Cité Engloutie"), Point(2869, -10432, "Sources Interdites"))),
