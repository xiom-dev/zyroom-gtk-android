...
* Un journal des mouvements : ce qui est entré et sorti d'un coffre depuis la
  dernière consultation. L'API n'en garde aucune trace, l'application est donc
  le seul témoin.
* L'arbre des compétences d'un personnage, avec l'avancement du niveau en cours
  et les branches entièrement montées.
* Les avant-postes tenus sur Atys, qui tient quoi, et le journal des prises et
  des pertes.
